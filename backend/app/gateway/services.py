...
async def start_run(
    ...
    # Extract model_name from request context for persistence in run records
    body_context = getattr(body, "context", None) or {}
    model_name = body_context.get("model_name") if isinstance(body_context, dict) else None
